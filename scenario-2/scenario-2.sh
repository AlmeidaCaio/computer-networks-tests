...
docker container exec firwll-1 sh -c 'ip route change default via 172.16.0.1 dev eth0 && ping -c 1 -t 1 172.16.0.1'
docker container exec router-1 sh -c 'ip route change default via 172.16.0.6 dev eth0 && ping -c 1 -t 1 172.16.0.6'
