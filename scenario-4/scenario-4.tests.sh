...
aux="`docker container exec workst-011 sh -c "echo -e -n '\n\n[workst-011] ' && ping -c 1 ${ip_s1}"`" ; echo -e ${aux} ; w1_s1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-011 sh -c "echo -e -n '\n\n[workst-011] ' && ping -c 1 ${ip_w2}"`" ; echo -e ${aux} ; w1_w2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-011 sh -c "echo -e -n '\n\n[workst-011] ' && ping -c 1 ${ip_w3}"`" ; echo -e ${aux} ; w1_w3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-011 sh -c "echo -e -n '\n\n[workst-011] ' && ping -c 1 ${ip_W1}"`" ; echo -e ${aux} ; w1_W1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-011 sh -c "echo -e -n '\n\n[workst-011] ' && ping -c 1 ${ip_W2}"`" ; echo -e ${aux} ; w1_W2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-011 sh -c "echo -e -n '\n\n[workst-011] ' && ping -c 1 ${ip_W3}"`" ; echo -e ${aux} ; w1_W3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-021 sh -c "echo -e -n '\n\n[workst-021] ' && ping -c 1 ${ip_s1}"`" ; echo -e ${aux} ; w2_s1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-021 sh -c "echo -e -n '\n\n[workst-021] ' && ping -c 1 ${ip_w1}"`" ; echo -e ${aux} ; w2_w1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-021 sh -c "echo -e -n '\n\n[workst-021] ' && ping -c 1 ${ip_w3}"`" ; echo -e ${aux} ; w2_w3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-021 sh -c "echo -e -n '\n\n[workst-021] ' && ping -c 1 ${ip_W1}"`" ; echo -e ${aux} ; w2_W1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-021 sh -c "echo -e -n '\n\n[workst-021] ' && ping -c 1 ${ip_W2}"`" ; echo -e ${aux} ; w2_W2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-021 sh -c "echo -e -n '\n\n[workst-021] ' && ping -c 1 ${ip_W3}"`" ; echo -e ${aux} ; w2_W3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-031 sh -c "echo -e -n '\n\n[workst-031] ' && ping -c 1 ${ip_s1}"`" ; echo -e ${aux} ; w3_s1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-031 sh -c "echo -e -n '\n\n[workst-031] ' && ping -c 1 ${ip_w1}"`" ; echo -e ${aux} ; w3_w1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-031 sh -c "echo -e -n '\n\n[workst-031] ' && ping -c 1 ${ip_w2}"`" ; echo -e ${aux} ; w3_w2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-111 sh -c "echo -e -n '\n\n[workst-111] ' && ping -c 1 ${ip_s0}"`" ; echo -e ${aux} ; W1_s0="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-111 sh -c "echo -e -n '\n\n[workst-111] ' && ping -c 1 ${ip_w2}"`" ; echo -e ${aux} ; W1_w2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-111 sh -c "echo -e -n '\n\n[workst-111] ' && ping -c 1 ${ip_w3}"`" ; echo -e ${aux} ; W1_w3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-111 sh -c "echo -e -n '\n\n[workst-111] ' && ping -c 1 ${ip_W1}"`" ; echo -e ${aux} ; W1_W1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-111 sh -c "echo -e -n '\n\n[workst-111] ' && ping -c 1 ${ip_W2}"`" ; echo -e ${aux} ; W1_W2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-111 sh -c "echo -e -n '\n\n[workst-111] ' && ping -c 1 ${ip_W3}"`" ; echo -e ${aux} ; W1_W3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-121 sh -c "echo -e -n '\n\n[workst-121] ' && ping -c 1 ${ip_s0}"`" ; echo -e ${aux} ; W2_s0="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-121 sh -c "echo -e -n '\n\n[workst-121] ' && ping -c 1 ${ip_w1}"`" ; echo -e ${aux} ; W2_w1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-121 sh -c "echo -e -n '\n\n[workst-121] ' && ping -c 1 ${ip_w3}"`" ; echo -e ${aux} ; W2_w3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-121 sh -c "echo -e -n '\n\n[workst-121] ' && ping -c 1 ${ip_W1}"`" ; echo -e ${aux} ; W2_W1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-121 sh -c "echo -e -n '\n\n[workst-121] ' && ping -c 1 ${ip_W2}"`" ; echo -e ${aux} ; W2_W2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-121 sh -c "echo -e -n '\n\n[workst-121] ' && ping -c 1 ${ip_W3}"`" ; echo -e ${aux} ; W2_W3="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-131 sh -c "echo -e -n '\n\n[workst-131] ' && ping -c 1 ${ip_s0}"`" ; echo -e ${aux} ; W3_s0="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
...
aux="`docker container exec workst-131 sh -c "echo -e -n '\n\n[workst-131] ' && ping -c 1 ${ip_w1}"`" ; echo -e ${aux} ; W3_w1="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
aux="`docker container exec workst-131 sh -c "echo -e -n '\n\n[workst-131] ' && ping -c 1 ${ip_w2}"`" ; echo -e ${aux} ; W3_w2="`if [ $(echo $aux | grep ' 0% packet loss' | wc -l) == '1' ] ; then echo -n ${passed} ; else echo -n ${failed} ; fi`"
