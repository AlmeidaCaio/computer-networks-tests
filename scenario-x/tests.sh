...
httpTestPID=$( docker container exec firwll-1 bash -c "{ tcpdump -i eth0 -n -e &> test-http.accept.firwll-1.log & } && echo \$!" )
...
httpTestPID=$( docker container exec firwll-1 bash -c "{ tcpdump -i eth0 -n -e &> test-http.reject.firwll-1.log & } && echo \$!" )
